...
- In this fork, Codex task execution must stay attached to the `codex:codex-rescue` subagent. Backgrounding is only allowed at the Claude subagent layer; do not detach Codex with `task --background`.
